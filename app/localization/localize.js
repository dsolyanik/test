...
(function () {
    ...
    angular
        .module('myApp.users')
        .factory('localize', Service).filter('i18n', ['localize', function (localize) {
        return function (input) {
            return localize.getLocalizedString(input);
        };
    }]);

    function Service($http, $rootScope, $window, $filter) {
            var localize = {
                ...
                initLocalizedResources:function () {
                    ...
                    localize.dictionary = {title: "pooooo"};
                },
